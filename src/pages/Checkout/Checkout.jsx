    ...
    <main className="checkout-page">
      <div className="container">
        ...
        <div className="checkout-layout">
          {/* FIX 8: Added id="checkout-form-el" so the Place Order button's form attribute resolves */}
          <form id="checkout-form-el" className="checkout-form" onSubmit={handleSubmit}>
          ...
          <aside className="order-summary">
            ...
            {/* FIX 8: form="checkout-form-el" now resolves — the form has that id */}
            <button
              type="submit"
